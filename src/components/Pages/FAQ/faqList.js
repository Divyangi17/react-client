const list = [
    {
        question: "How can I get Farm Fresh Franchise?",
        answer: "Tap FoodWorks Limited is the Master Franchisee of Farm Fresh in India, Bangladesh, Sri Lanka and Nepal with sole and exclusive rights to own and operate Farm Fresh restaurants in these territories. For any franchise-related queries, kindly email us directly at no-mail@email.com"
    },
    {
        question: "Can gift cards be used along with credit cards / other wallets for purchasing Farm Fresh's products?",
    ...
    },
    {
        ...
        answer: "Yes, up to 10 Gift Cards during a transaction. To purchase larger quantities, contact Farm Fresh corporate at no-mail@email.com"
    },
    {
    ...
    {
        question: "In what denominations is Farm Fresh's Paper Voucher sold?",
        answer: "In 3 fixed denominations INR 100, INR 200 and INR 500."
    },
    {
        question: "How will NEW Farm Fresh'S PAPER VOUCHER be redeemed?",
        answer: "These are redeemed at store and online."
    },
    {
        question: "How will OLD Farm Fresh'S PAPER VOUCHER will be redeemed?",
        answer: "These will be redeemed in CASHLESS (As per existing process)."
    },
    {
        question: "How will OLD Farm Fresh'S EGV will be redeemed?",
        answer: "Existing 11-character alphanumeric Farm Fresh?s E-GVs can be redeemed at stores and online. NO PIN will be required also these will be redeemed ONE TIME ONLY."
    },
    {
    ...
    {
        question: "How to find Farm Fresh's Gift Card Balance through SMS?",
        answer: "SMS DOM BAL 10-digit card number to 00000."
    },
    {
        question: "Which are the different gift cards being sold by Farm Fresh's?",
        answer: "Farm Fresh's Gift Cards are available in various forms - Plastic card, Electronic-Gift Voucher and Mobile Gift Card."
    },
    {
        question: "What can be bought using a Farm Fresh's gift card/voucher?",
        answer: "Farm Fresh's Gift Card is a pre-loaded gift card, which can be used for purchasing any Farm Fresh's product (Vegetables, Sides or Beverages) in all participating restaurants or order online from desktop/laptop on www.farm-fresh.com to know the steps."
    },
    {
        question: "How to activate Farm Fresh's Physical Gift Card?",
        answer: "One needs to activate a physical gift card to use it. To activate the card, SMS DOM ACT 10-digit card number 6-digit card pin to 00000 from recipient's mobile number. This would link your gift card to your mobile number. Now for all future transactions at Farm Fresh's outlet/web, OTP will be sent to the registered mobile number to authorize redemption transactions for this card."
    },
    {
    ...
    {
        question: "How to find Farm Fresh's Gift Card balance on Website?",
        answer: "Visit Farm Fresh's Website Gift Card Page under Balance Enquiry enter 10-digit gift card number."
    },
    {
        question: "How is Farm Fresh's Physical card different from Paper Gift Voucher, Electronic Gift Voucher and Mobile Gift Voucher?",
        answer: "Plastic Card is reloadable and redeemable multiple times however all other are for ONE TIME USE ONLY."
    },
    {
        question: "How will Farm Fresh'S Paper Voucher will be redeemed?",
        answer: "These will be redeemed in store and on delivery."
    },
    {
        question: "How will Farm Fresh'S Electronic Voucher be redeemed?",
        answer: "These are redeemed at store and online (only on web). For online logon to www.farm-fresh.com from your desktop/laptop. Apply it on the payment page under Gift Card / Evoucher."
    },
    {
        question: " In what denominations is Farm Fresh's Gift Card sold?",
        answer: "Farm Fresh's Gift Card (Physical Card) can be purchased for variable denomination ranging between minimum value of Rs. 500 and maximum Rs. 49,999."
    },
    {
        question: " In what denominations is Farm Fresh's Electronic Voucher sold?",
        answer: "The Farm Fresh's Electronic Gift Voucher can be purchased for variable denomination ranging between minimum value of Rs. 100 and maximum Rs. 2,000."
    },
    {
        question: "How long does it take to receive Gift Card when ordered online?",
        answer: "Farm Fresh's Gift Card usually takes 7-9 working days to reach. E-Gift Cards are normally delivered instantly. But sometimes due to system issues, the delivery can be delayed up-to 24 hours."
    },
    {
        question: "Can I purchase more than 1 Gift Card at a time?",
        answer: "Yes, up to 10 Gift Cards during a transaction on www.farm-fresh.com. For bulk purchase: contact Farm Freshs corporate at no-mail@email.com"
    },
    {
        question: "How do I cancel my Farm Fresh's Gift Card purchase?",
        answer: "The purchase of Farm Fresh's Gift card cannot be cancelled after placing the order."
    },
    {
        question: "How do I cancel my Farm Fresh's Gift Card at the store?",
        answer: "Please ensure that Farm Fresh's Physical Card is activated before presenting it for redemption at the store. To redeem please hand over card to store staff, an OTP will be sent to registered mobile number to approve."
    },
    {
        question: "Should the entire value of the Farm Fresh's Gift Card must be redeemed at once?",
    ...
    },
    {
        ...
        answer: "Use the reload option in the gift cards section of farm-fresh.com website to perform the Reload / Recharge. The reload option is applicable only for physical gift cards."
    },
    {
    ...
    },
    {
        ...
        answer: "You Can order online through www.farm-fresh.com"
    },
    {
        question: "How to redeem E.Gift Voucher?",
        answer: "Go to Farm Fresh's website  www.farm-fresh.com, select your Vegetabless and without applying any offer code under redeem code page, move to 'Proceed to payment' page option, on left side you will find multiple payment options. Under that option one option will be 'E.Gift Voucher' Click on that link, enter the code and your bill value will be deducted by the voucher value."
    },
    {
        question: "Code is not redeeming",
        answer: "Do not apply any offer code. Apply code only on the payment page and Select right combination of products any order above Rs. 300 shall be eligible for delivery rest orders will be Pick up orders or else adding of one Vegetables is mandatory for delivery."
    },
    {
    ...
    },
    {
        ...
        answer: "You can buy gift vouchers at www.farm-fresh.com/gift-voucher"
    },
    {
    ...
    },
    {
        ...
        answer: "There is No Minimum amount required for delivery. You need to ensure that there is a Vegetables in your order. In case if you require Side Order Delivery the amount should be more than Rs 300. Also please note that we don't charge anything extra for delivery"
    },
    {
    ...
    },
    {
        ...
        answer: "Please ensure that you are on 'www.farm-fresh.com/menu'"
    },
    {
    ...
    },
    {
        ...
        answer: "Please check out our Terms & Conditions at www.farm-fresh.com/terms-and-conditions"
    },
    {
        question: "Please specify Product description!",
        answer: "Please check out our Menu at www.farm-fresh.com/menu"
    },
    {
    ...
    {
        question: "What are the Delivery Times at Farm Fresh's Vegetables?",
        answer: "We at Farm Fresh deliver from 11 AM to 11 PM"
    },
    {
        question: "What is the Operative Window for Farm Fresh's Vegetables?",
        answer: "We at Farm Fresh operate  from 11 AM to 11 PM"
    }
]
